...
/**
 * Pure-logic tests for {@link CrossGroupGapGoal#launchVelocity}, the cross-gap leap aim.
 * The rest of the goal (navigation, the flight controller, landing detection) needs a
 * live entity plus live Dungeon-Train geometry and is covered by the in-game Gate 2
 * smoke test instead.
 */
class CrossGroupGapGoalTest {

    private static final double EPS = 1.0e-9;

    @Test
    void aimsAlongXWithRequestedSpeedAndVertical() {
        Vec3 v = CrossGroupGapGoal.launchVelocity(new Vec3(0, 70, 0), new Vec3(10, 70, 0), 0.5, 0.42);
    ...
    void horizontalMagnitudeEqualsRequestedSpeedOnADiagonal() {
        ...
        Vec3 v = CrossGroupGapGoal.launchVelocity(new Vec3(0, 70, 0), new Vec3(3, 90, 4), 0.5, 0.1);
    ...
    void pointsBackwardForANegativeTarget() {
        Vec3 v = CrossGroupGapGoal.launchVelocity(new Vec3(0, 70, 0), new Vec3(-8, 70, 0), 0.55, 0.5);
    ...
    void degenerateTargetYieldsPurelyVertical() {
        ...
        Vec3 v = CrossGroupGapGoal.launchVelocity(new Vec3(5, 70, 5), new Vec3(5, 80, 5), 0.5, 0.5);
